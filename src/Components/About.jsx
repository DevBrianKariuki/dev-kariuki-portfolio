...
const About = () => {
  return (
    <section
      id="about"
      className={`w-full bg-secondaryBackground py-8 flex flex-col items-center md:flex-row ${styles.flexCenter} ${styles.paddingY}`}
    >
      <div className="md:w-[70%] flex flex-col items-center md:flex-row">
        ...
        <div className="text-center justify-center md:w-[50%] md:text-left flex flex-col">
          ...
          <h1 className="text-white px-5 md:px-0 py-2 font-poppins font-bold text-[25px]">
            A dedicated Front-end Developer based in Nairobi, Kenya 📍
          </h1>

          <p className="text-dimWhite font-inter px-3 md:px-0 leading-[26px] py-2">
